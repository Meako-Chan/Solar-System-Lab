...
const diameter = "7,917.5 miles";
solarSystem[2].diameter = diameter;
...
let sum = Number(system.jupiter.satellites) + system.saturn.satellites + system.uranus.satellites + system.neptune.satellites;
console.log(sum)
...
let momentum1 = system.jupiter.velocity * system.jupiter.mass;
let momentum2 = system.pluto.velocity * system.pluto.mass;
